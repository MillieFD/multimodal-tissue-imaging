...
import json
import traceback
from ctypes import cdll, c_int, c_ushort, c_uint, c_long, create_string_buffer, c_ulong, c_ubyte, c_double, c_float, \
    c_longlong, POINTER, byref, c_int32
...
class OceanDirectAPI:
    ...
    def add_network_device(self, ipAddress: str, deviceType: str) -> int:
        ...
        try:
            deviceId = self.oceandirect.odapi_add_network_devices(ipAddress.encode('utf-8'), deviceType.encode('utf-8'),
                                                                  err_cp)
        except Exception as e:
            exe_msg = traceback.format_exc()
            sdk_data_json = json.dumps(exe_msg)
...
class Spectrometer():
    ...
    def open_device(self) -> None:
        ...
        if err_cp[0] != 0:
            ...
            self.pixel_count_unformatted = self.oceandirect.odapi_get_unformatted_spectrum_length(self.device_id,
                                                                                                  err_cp)
            if err_cp[0] != 0:
    ...
    def get_wavelengths(self) -> list[float]:
        ...
        if self.wavelengths is None:
            ...
            err_cp = (c_long * 1)(0)
            buffer_size = self.oceandirect.odapi_get_wavelengths(self.device_id, err_cp, wl_c,
    ...
    def get_indices_at_wavelengths(self, wavelengths: list[float]) -> tuple[list[int], list[float]]:
        ...
        err_cp = (c_long * 1)(0)
        indexCount = self.oceandirect.odapi_get_indices_at_wavelengths(self.device_id, err_cp, c_indices, length,
                                                                       c_wavelength, length)
    ...
    def get_indices_at_wavelength_range(self, lo: float, hi: float, length: int) -> tuple[list[int], list[float]]:
        ...
        err_cp = (c_long * 1)(0)
        wavelengthFoundCount = self.oceandirect.odapi_get_indices_at_wavelength_range(self.device_id, err_cp, c_indices,
                                                                                      wavelengthCount,
                                                                                      c_wavelength, wavelengthCount,
                                                                                      c_double(lo), c_double(hi))
    ...
    def get_electric_dark_pixel_indices(self) -> list[int]:
        ...
        err_cp = (c_long * 1)(0)
        self.oceandirect.odapi_get_electric_dark_pixel_indices(self.device_id, err_cp, ed_idx_c,
    ...
    def get_acquisition_delay_increment(self) -> int:
        ...
        err_cp = (c_long * 1)(0)
        delay_increment_microsecond = self.oceandirect.odapi_get_acquisition_delay_increment_microseconds(
    ...
    def get_acquisition_delay_maximum(self) -> int:
        ...
        err_cp = (c_long * 1)(0)
        delay_maximum_microsecond = self.oceandirect.odapi_get_acquisition_delay_maximum_microseconds(self.device_id,
                                                                                                      err_cp)
    ...
    def get_acquisition_delay_minimum(self) -> int:
        ...
        err_cp = (c_long * 1)(0)
        delay_minimum_microsecond = self.oceandirect.odapi_get_acquisition_delay_minimum_microseconds(self.device_id,
                                                                                                      err_cp)
    ...
    def get_stored_dark_spectrum(self) -> list[float]:
        ...
        err_cp = (c_long * 1)(0)
        self.oceandirect.odapi_get_stored_dark_spectrum(self.device_id, err_cp, double_array,
                                                        self.pixel_count_formatted)
        if err_cp[0] != 0:
    ...
    def get_dark_corrected_spectrum1(self, darkSpectrum: list[float]) -> list[float]:
        ...
        self.oceandirect.odapi_get_dark_corrected_spectrum1(self.device_id, err_cp, dark_spectrum_array,
    ...
    def dark_correct_spectrum1(self, illuminatedSpectrum: list[float]) -> list[float]:
        ...
        self.oceandirect.odapi_dark_correct_spectrum1(self.device_id, err_cp, illuminated_spectrum_array,
    ...
    def get_dark_corrected_spectrum2(self) -> list[float]:
        ...
        corrected_spectrum_array = (c_double * self.pixel_count_formatted)()
        err_cp = (c_long * 1)(0)
        self.oceandirect.odapi_get_dark_corrected_spectrum2(self.device_id, err_cp, corrected_spectrum_array,
                                                            self.pixel_count_formatted)
        if err_cp[0] != 0:
    ...
    def dark_correct_spectrum2(self, darkSpectrum: list[float], illuminatedSpectrum: list[float]) -> list[float]:
        ...
        self.oceandirect.odapi_dark_correct_spectrum2(self.device_id, err_cp, dark_spectrum_array,
                                                      dark_spectrum_array_count,
    ...
    def get_nonlinearity_corrected_spectrum1(self, darkSpectrum: list[float]) -> list[float]:
        ...
        self.oceandirect.odapi_get_nonlinearity_corrected_spectrum1(self.device_id, err_cp, dark_spectrum_array,
                                                                    dark_spectrum_array_count,
    ...
    def nonlinearity_correct_spectrum1(self, illuminatedSpectrum: list[float]) -> list[float]:
        ...
        self.oceandirect.odapi_nonlinearity_correct_spectrum1(self.device_id, err_cp, illuminated_spectrum_array,
                                                              illuminated_spectrum_array_count,
                                                              corrected_spectrum_array, self.pixel_count_formatted)
        if err_cp[0] != 0:
    ...
    def get_nonlinearity_corrected_spectrum2(self) -> list[float]:
        ...
        self.oceandirect.odapi_get_nonlinearity_corrected_spectrum2(self.device_id, err_cp, corrected_spectrum_array,
                                                                    self.pixel_count_formatted)
        if err_cp[0] != 0:
    ...
    def nonlinearity_correct_spectrum2(self, darkSpectrum: list[float], illuminatedSpectrum: list[float]) -> list[
        float]:
        """!
        ...
        self.oceandirect.odapi_nonlinearity_correct_spectrum2(self.device_id, err_cp, dark_spectrum_array,
                                                              dark_spectrum_array_count,
    ...
    class Advanced():
        ...
        def get_unformatted_spectrum_length(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            unformatted_length = self.device.oceandirect.odapi_get_unformatted_spectrum_length(self.device.device_id,
                                                                                               err_cp)
        ...
        def set_wavelength_coeffs(self, wavelengthCoeffs: list[float]) -> None:
            ...
            self.device.oceandirect.odapi_set_wavelength_coeffs(self.device.device_id, err_cp, double_array,
                                                                double_array_count)
        ...
        def get_nonlinearity_coeffs(self) -> list[float]:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_get_nonlinearity_coeffs(self.device.device_id, err_cp, nl_coeff,
                                                                      num_coeffs)
        ...
        def set_nonlinearity_coeffs(self, nonlinearityCoeffs: list[float]) -> None:
            ...
            byte_write_count = self.device.oceandirect.odapi_adv_set_nonlinearity_coeffs(self.device.device_id, err_cp,
                                                                                         double_array,
                                                                                         double_array_count)
        ...
        def get_nonlinearity_coeffs1(self, index: int) -> float:
            ...
            err_cp = (c_long * 1)(0)
            nl_coefficient = self.device.oceandirect.odapi_adv_get_nonlinearity_coeffs1(self.device.device_id, err_cp,
                                                                                        c_int(index))
        ...
        def set_nonlinearity_coeffs1(self, index: int, nl_coefficient: float) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_nonlinearity_coeffs1(self.device.device_id, err_cp, c_int(index),
                                                                       c_double(nl_coefficient))
        ...
        def set_tec_setpoint(self, temp_C: float) -> None:
            ...
            err_cp = (c_long * 1)(0)
            temp = self.device.oceandirect.odapi_adv_tec_set_temperature_setpoint_degrees_C(self.device.device_id,
                                                                                            err_cp, c_double(temp_C))
        ...
        def set_tec_fan_enable(self, fanEnable: bool) -> None:
            ...
            err_cp = (c_long * 1)(0)
            enabled = self.device.oceandirect.odapi_adv_tec_set_fan_enable(self.device.device_id, err_cp,
                                                                           c_ubyte(fanEnable))
        ...
        def get_temperature(self, index: int) -> float:
            ...
            if index < tc:
                ...
                if err_cp[0] != 0:
                    error_msg = self.device.decode_error(err_cp[0],
        ...
        def get_irrad_calibration(self) -> list[float]:
            ...
            bufferSize = self.device.oceandirect.odapi_adv_get_irrad_calibration(self.device.device_id, err_cp,
                                                                                 irad_cal, c_int(pixel_count))
        ...
        def set_irrad_calibration(self, iradCal: list[float]) -> None:
            ...
            buffer_size = self.device.oceandirect.odapi_adv_set_irrad_calibration(self.device.device_id, err_cp,
                                                                                  float_array, float_array_count)
        ...
        def get_irrad_calibration_collection_area(self) -> float:
            ...
            if has_ca:
                collection_area = self.device.oceandirect.odapi_adv_get_irrad_collection_area(self.device.device_id,
                                                                                              err_cp)
            else:
        ...
        def set_irrad_calibration_collection_area(self, area: float) -> None:
            ...
            if has_ca:
                self.device.oceandirect.odapi_adv_set_irrad_collection_area(self.device.device_id, err_cp,
                                                                            c_float(area))
            else:
        ...
        def get_optical_bench_slit_width(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            slit_width = self.device.oceandirect.odapi_adv_get_optical_bench_slit_width_microns(self.device.device_id,
                                                                                                err_cp)
        ...
        def set_optical_bench_slit_width(self, widthMicrons: int) -> None:
            ...
            self.device.oceandirect.odapi_adv_set_optical_bench_slit_width_microns(self.device.device_id, err_cp,
                                                                                   c_ushort(widthMicrons))
        ...
        def set_optical_bench_serial_number(self, benchSerialNumber: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_optical_bench_serial_number(self.device.device_id, err_cp,
        ...
        def set_optical_bench_coating(self, benchCoating: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_optical_bench_coating(self.device.device_id, err_cp,
                                                                        benchCoating.encode('utf-8'), len(benchCoating))
        ...
        def set_optical_bench_filter(self, benchFilter: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_optical_bench_filter(self.device.device_id, err_cp,
                                                                       benchFilter.encode('utf-8'), len(benchFilter))
        ...
        def set_optical_bench_grating(self, benchGrating: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_optical_bench_grating(self.device.device_id, err_cp,
                                                                        benchGrating.encode('utf-8'), len(benchGrating))
        ...
        def get_optical_bench_fiber_diameter(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            fiber_diameter = self.device.oceandirect.odapi_adv_get_optical_bench_fiber_diameter(self.device.device_id,
                                                                                                err_cp)
        ...
        def set_optical_bench_fiber_diameter(self, diameterMicrons: int) -> None:
            ...
            self.device.oceandirect.odapi_adv_set_optical_bench_fiber_diameter(self.device.device_id, err_cp,
                                                                               c_ushort(diameterMicrons))
        ...
        def get_optical_bench_id(self) -> str:
            ...
            benchId = self.device.oceandirect.odapi_adv_get_optical_bench_id(self.device.device_id, err_cp, bench_id_cp,
                                                                             100)
        ...
        def set_optical_bench_id(self, benchID: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_optical_bench_id(self.device.device_id, err_cp,
                                                                   benchID.encode('utf-8'), len(benchID))
        ...
        def has_light_source_enable(self, light_source_index: int) -> bool:
            ...
            err_cp = (c_long * 1)(0)
            status = self.device.oceandirect.odapi_adv_light_source_has_enable(self.device.device_id, err_cp,
                                                                               light_source_index)
        ...
        def is_light_source_enabled(self, light_source_index: int) -> bool:
            ...
            err_cp = (c_long * 1)(0)
            status = self.device.oceandirect.odapi_adv_light_source_is_enabled(self.device.device_id, err_cp,
                                                                               light_source_index)
        ...
        def enable_light_source(self, light_source_index: int, enable: bool) -> None:
            ...
            if enable:
                self.device.oceandirect.odapi_adv_light_source_set_enable(self.device.device_id, err_cp,
                                                                          light_source_index, self.lamp_on)
            else:
                self.device.oceandirect.odapi_adv_light_source_set_enable(self.device.device_id, err_cp,
                                                                          light_source_index, self.lamp_off)
        ...
        def light_source_has_variable_intensity(self, light_source_index: int) -> bool:
            ...
            err_cp = (c_long * 1)(0)
            status = self.device.oceandirect.odapi_adv_light_source_has_variable_intensity(self.device.device_id,
                                                                                           err_cp, light_source_index)
        ...
        def get_light_source_intensity(self, light_source_index: int) -> float:
            ...
            err_cp = (c_long * 1)(0)
            light_intensity = self.device.oceandirect.odapi_adv_light_source_get_intensity(self.device.device_id,
                                                                                           err_cp, light_source_index)
        ...
        def set_single_strobe_delay(self, delayMicrosecond: int) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_single_strobe_delay(self.device.device_id, err_cp,
                                                                      c_ulong(delayMicrosecond))
        ...
        def set_single_strobe_width(self, widthMicrosecond: int) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_single_strobe_width(self.device.device_id, err_cp,
                                                                      c_ulong(widthMicrosecond))
        ...
        def get_single_strobe_delay_minimum(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            minimum_microseconds = self.device.oceandirect.odapi_adv_get_single_strobe_delay_minimum(
        ...
        def get_single_strobe_delay_maximum(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            maximum_microseconds = self.device.oceandirect.odapi_adv_get_single_strobe_delay_maximum(
                self.device.device_id, err_cp)
        ...
        def get_single_strobe_delay_increment(self) -> int:
            ...
            """
            err_cp = (c_long * 1)(0)
            delay_increment = self.device.oceandirect.odapi_adv_get_single_strobe_delay_increment(self.device.device_id,
                                                                                                  err_cp)
        ...
        def get_single_strobe_width_minimum(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            width_minimum = self.device.oceandirect.odapi_adv_get_single_strobe_width_minimum(self.device.device_id,
                                                                                              err_cp)
        ...
        def get_single_strobe_width_maximum(self) -> int:
            ...
            """
            err_cp = (c_long * 1)(0)
            width_maximum = self.device.oceandirect.odapi_adv_get_single_strobe_width_maximum(self.device.device_id,
                                                                                              err_cp)
        ...
        def get_single_strobe_width_increment(self) -> int:
            ...
            """
            err_cp = (c_long * 1)(0)
            width_increment = self.device.oceandirect.odapi_adv_get_single_strobe_width_increment(self.device.device_id,
                                                                                                  err_cp)
        ...
        def get_single_strobe_cycle_maximum(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            cyle_maximum = self.device.oceandirect.odapi_adv_get_single_strobe_cycle_maximum(self.device.device_id,
                                                                                             err_cp)
        ...
        def set_continuous_strobe_enable(self, enable: bool) -> None:
            ...
            if enable:
                self.device.oceandirect.odapi_adv_set_continuous_strobe_enable(self.device.device_id, err_cp,
                                                                               self.lamp_on)
            else:
                self.device.oceandirect.odapi_adv_set_continuous_strobe_enable(self.device.device_id, err_cp,
                                                                               self.lamp_off)
        ...
        def get_continuous_strobe_period(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            period_microsecond = self.device.oceandirect.odapi_adv_get_continuous_strobe_period_micros(
                self.device.device_id, err_cp)
        ...
        def get_continuous_strobe_width(self) -> int:
            ...
            """
            err_cp = (c_long * 1)(0)
            width_microsecond = self.device.oceandirect.odapi_adv_get_continuous_strobe_width_micros(
                self.device.device_id, err_cp)
        ...
        def set_continuous_strobe_width(self, widthMicrosecond: int) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_continuous_strobe_width_micros(self.device.device_id, err_cp,
                                                                                 c_ulong(widthMicrosecond))
        ...
        def get_data_buffer_number_of_elements(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            number_of_elements = self.device.oceandirect.odapi_adv_get_data_buffer_number_of_elements(
                self.device.device_id, err_cp)
        ...
        def get_data_buffer_capacity_maximum(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            maximum_buffer_capacity = self.device.oceandirect.odapi_adv_get_data_buffer_capacity_maximum(
                self.device.device_id, err_cp)
        ...
        def get_data_buffer_capacity_minimum(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            minimum_buffer_capacity = self.device.oceandirect.odapi_adv_get_data_buffer_capacity_minimum(
                self.device.device_id, err_cp)
        ...
        def get_raw_spectrum_with_metadata(self, list_raw_spectra: list[list[float]], list_timestamp: list[int],
                                           buffer_size: int) -> int:
            """!
            ...
            err_cp = (c_long * 1)(0)
            spectraCount = self.device.oceandirect.odapi_get_raw_spectrum_with_metadata(self.device.device_id, err_cp,
                                                                                        buffer, buffer_size,
        ...
        def get_usb_endpoint_primary_out(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            usb_primary_endpoint_out = self.device.oceandirect.odapi_get_device_usb_endpoint_primary_out(
                self.device.device_id, err_cp)
        ...
        def get_usb_endpoint_primary_in(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            usb_primary_endpoint_in = self.device.oceandirect.odapi_get_device_usb_endpoint_primary_in(
                self.device.device_id, err_cp)
        ...
        def get_usb_endpoint_secondary_out(self) -> int:
            ...
            err_cp = (c_long * 1)(0)
            usb_secondary_endpoint_out = self.device.oceandirect.odapi_get_device_usb_endpoint_secondary_out(
                self.device.device_id, err_cp)
        ...
        def get_usb_endpoint_secondary_in(self) -> int:
            ...
            usb_secondary_endpoint_in = self.device.oceandirect.odapi_get_device_usb_endpoint_secondary_in(
                self.device.device_id, err_cp)
            if err_cp[0] != 0:
        ...
        def read_eeprom_slot(self, slot_number: int, data_size: int) -> list[c_ubyte]:
            ...
            self.device.oceandirect.odapi_adv_eeprom_read_slot(self.device.device_id, err_cp, slot_number, buffer,
                                                               data_size)
        ...
        def get_revision_hardware(self) -> str:
            ...
            revision_hardware = self.device.oceandirect.odapi_adv_get_revision_hardware(self.device.device_id, err_cp,
                                                                                        hw_revision_cp, 100)
        ...
        def get_revision_firmware(self) -> str:
            ...
            bytesRead = self.device.oceandirect.odapi_adv_get_revision_firmware(self.device.device_id, err_cp,
                                                                                fw_revision_cp, 100)
        ...
        def get_revision_fpga(self) -> str:
            ...
            bytesRead = self.device.oceandirect.odapi_adv_get_revision_fpga(self.device.device_id, err_cp,
                                                                            fpga_revision_cp, 100)
        ...
        def ipv4_is_dhcp_enabled(self, ifNum: int) -> bool:
            ...
            err_cp = (c_long * 1)(0)
            enable = self.device.oceandirect.odapi_adv_ipv4_is_dhcp_enabled(self.device.device_id, err_cp,
                                                                            c_ubyte(ifNum))
        ...
        def ipv4_get_number_of_ip_addresses(self, ifNum: int) -> int:
            ...
            err_cp = (c_long * 1)(0)
            numIpAddress = self.device.oceandirect.odapi_adv_ipv4_get_number_of_ip_addresses(self.device.device_id,
                                                                                             err_cp, ifNum)
        ...
        def ipv4_read_ip_address(self, ifNum: int, addressIndex: int) -> tuple[list[int], int]:
            ...
            self.device.oceandirect.odapi_adv_ipv4_read_ip_address(self.device.device_id, err_cp, c_ubyte(ifNum),
        ...
        def ipv4_add_static_ip_address(self, ifNum: int, ipAddress: list[int], netmask: int) -> None:
            ...
            self.device.oceandirect.odapi_adv_ipv4_add_static_ip_address(self.device.device_id, err_cp, c_ubyte(ifNum),
                                                                         ip_address_cp, 4, c_uint(netmask))
            if err_cp[0] != 0:
        ...
        def ipv4_delete_static_ip_address(self, ifNum: int, addressIndex: int) -> None:
            ...
            self.device.oceandirect.odapi_adv_ipv4_delete_static_ip_address(self.device.device_id, err_cp,
                                                                            c_ubyte(ifNum), c_ubyte(addressIndex))
            if err_cp[0] != 0:
        ...
        def ipv4_set_default_gateway_ip_address(self, ifNum: int, ipAddress: list[int]) -> None:
            ...
            self.device.oceandirect.odapi_adv_ipv4_set_default_gateway_ip_address(self.device.device_id, err_cp,
                                                                                  c_ubyte(ifNum), ip_address_cp, 4)
            if err_cp[0] != 0:
        ...
        def ipv4_get_default_gateway_ip_address(self, ifNum: int) -> list[int]:
            ...
            err_cp = (c_long * 1)(0)
            ip_address_cp = (c_ubyte * 4)(0)
            self.device.oceandirect.odapi_adv_ipv4_get_default_gateway_ip_address(self.device.device_id, err_cp,
                                                                                  c_ubyte(ifNum),
                                                                                  ip_address_cp, 4)
        ...
        def get_device_original_manufacturer_string(self) -> str:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_get_device_original_manufacturer_string(self.device.device_id, err_cp,
                                                                                      orig_manufacturer, 50)
        ...
        def get_device_original_model_string(self) -> str:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_get_device_original_model_string(self.device.device_id, err_cp,
                                                                               orig_model, 50)
        ...
        def get_device_manufacturer_string(self) -> str:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_get_device_manufacturer_string(self.device.device_id, err_cp,
                                                                             manufacturer, 50)
        ...
        def set_device_manufacturer_string(self, manufacturer: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_device_manufacturer_string(self.device.device_id, err_cp,
        ...
        def set_device_model_string(self, model: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_device_model_string(self.device.device_id, err_cp,
                                                                      model.encode('utf-8'), len(model))
        ...
        def get_command_list(self) -> list[int]:
            ...
            bufferSize = self.device.oceandirect.odapi_adv_get_command_list(self.device.device_id, err_cp,
                                                                            command_array, c_int(command_count))
        ...
        def set_serial_number(self, serialNumber: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            error_msg = self.device.oceandirect.odapi_set_serial_number(self.device.device_id, err_cp,
                                                                        serialNumber.encode('utf-8'), len(serialNumber))
        ...
        def set_device_alias(self, deviceAlias: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_device_alias(self.device.device_id, err_cp,
                                                               deviceAlias.encode('utf-8'), len(deviceAlias))
        ...
        def set_user_string(self, userString: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_set_user_string(self.device.device_id, err_cp, userString.encode('utf-8'),
                                                          len(userString))
        ...
        def set_user_string2(self, index: int, userString: str) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_set_user_string1(self.device.device_id, err_cp, c_int(index),
                                                           userString.encode('utf-8'), len(userString))
        ...
        def set_autonull_baseline_level(self, baselineLevel: int) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_autonull_baseline_level(self.device.device_id, err_cp,
                                                                          c_int(baselineLevel))
        ...
        def set_autonull_saturation_level(self, saturation: int) -> None:
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_autonull_saturation_level(self.device.device_id, err_cp,
                                                                            c_int(saturation))
        ...
        def get_active_pixel_range(self) -> list[int]:
            ...
            range = (c_int * 10)(0)
            err_cp = (c_long * 1)(0)
            elementCopied = self.device.oceandirect.odapi_get_active_pixel_range(self.device.device_id, err_cp, range,
                                                                                 10)
        ...
        def get_optical_dark_pixel_range(self) -> list[int]:
            ...
            range = (c_int * 10)(0)
            err_cp = (c_long * 1)(0)
            elementCopied = self.device.oceandirect.odapi_get_optical_dark_pixel_range(self.device.device_id, err_cp,
                                                                                       range, 10)
        ...
        def get_transition_pixel_range(self) -> list[int]:
            ...
            range = (c_int * 10)(0)
            err_cp = (c_long * 1)(0)
            elementCopied = self.device.oceandirect.odapi_get_transition_pixel_range(self.device.device_id, err_cp,
                                                                                     range, 10)
        ...
        def get_bad_pixel_indices(self) -> list[int]:
            ...
            range = (c_int * 10)(0)
            err_cp = (c_long * 1)(0)
            elementCopied = self.device.oceandirect.odapi_get_bad_pixel_indices(self.device.device_id, err_cp, range,
                                                                                10)
        ...
        def set_bad_pixel_indices(self, badPixelIndices: list[int]) -> None:
            ...
            byte_write_count = self.device.oceandirect.odapi_set_bad_pixel_indices(self.device.device_id, err_cp,
                                                                                   int_array, int_array_count)
        ...
        def get_network_interface_type(self, interfaceIndex: int) -> int:
            ...
            """
            err_cp = (c_long * 1)(0)
            if_type = self.device.oceandirect.odapi_adv_network_conf_get_interface_type(self.device.device_id, err_cp,
        ...
        def get_network_interface_status(self, interfaceIndex: int) -> bool:
            ...
            """
            err_cp = (c_long * 1)(0)
            enabled = self.device.oceandirect.odapi_adv_network_conf_get_interface_status(self.device.device_id, err_cp,
                                                                                          c_uint(interfaceIndex))
        ...
        def set_network_interface_status(self, interfaceIndex: int, enable: bool) -> None:
            ...
            if enable:
                self.device.oceandirect.odapi_adv_network_conf_set_interface_status(self.device.device_id, err_cp,
                                                                                    c_uint(interfaceIndex), c_ubyte(1))
            else:
                self.device.oceandirect.odapi_adv_network_conf_set_interface_status(self.device.device_id, err_cp,
                                                                                    c_uint(interfaceIndex), c_ubyte(0))
        ...
        def save_network_interface_setting(self, interfaceIndex: int) -> None:
            ...
            """
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_network_conf_save_interface_setting(self.device.device_id, err_cp,
                                                                                  c_uint(interfaceIndex))
        ...
        def get_ethernet_gigabit_enable_status(self, interfaceIndex: int) -> bool:
            ...
            """
            err_cp = (c_long * 1)(0)
            status = self.device.oceandirect.odapi_adv_ethernet_get_gigabit_enable_status(self.device.device_id, err_cp,
                                                                                          c_uint(interfaceIndex))
        ...
        def set_ethernet_gigabit_enable_status(self, interfaceIndex: int, enable: bool) -> None:
            ...
            err_cp = (c_long * 1)(0)
            if enable:
                self.device.oceandirect.odapi_adv_ethernet_set_gigabit_enable_status(self.device.device_id, err_cp,
                                                                                     c_uint(interfaceIndex), 1)
            else:
                self.device.oceandirect.odapi_adv_ethernet_set_gigabit_enable_status(self.device.device_id, err_cp,
                                                                                     c_uint(interfaceIndex), 0)
        ...
        def get_ethernet_mac_address(self, interfaceIndex: int) -> list[int]:
            ...
            self.device.oceandirect.odapi_adv_ethernet_get_mac_address(self.device.device_id, err_cp,
                                                                       c_uint(interfaceIndex), mac_address_cp,
                                                                       array_len)
        ...
        def set_ethernet_mac_address(self, interfaceIndex: int, macAddress: list[int]) -> None:
            ...
            self.device.oceandirect.odapi_adv_ethernet_set_mac_address(self.device.device_id, err_cp,
                                                                       c_uint(interfaceIndex), mac_address_cp,
                                                                       array_len)
            if err_cp[0] != 0:
